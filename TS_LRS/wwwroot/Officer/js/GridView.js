$(document).ready(function () {
    ...
    pdl_table = $('.ghmc_table').DataTable({
        ...
        buttons: [
            ...
            },
            {
                ...
                // title: "LAYOUT REGULARIZATION SCHEME  " + formatted_date + "" + "",
            ...
            },
            {
                ...
                //title: "LAYOUT REGULARIZATION SCHEME <br> <label text-align: 'left'><font color='red' size='4px' text-align='left'> " + formatted_date + "</font></label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<label text-align='right'><font color='red' size='4px' text-align='right'></font></label>",
                fileName: "DETAILS OF PLOTS/LAYOUTS APPLIED FOR REGULARIZATION",
                titleAttr: 'Print',
                autoPrint: true,
    ...
    pdl_table = $('.ghmc_table_LRS').DataTable({
        language: {
            search: "_INPUT_",
            searchPlaceholder: "Search records here",
            //info: " _PAGE_ of _PAGES_ pages",
